...
SimileAjax.DateTime.QUATERMINUTE	= 2;
SimileAjax.DateTime.MINUTE			= 3;
SimileAjax.DateTime.QUATERHOUR		= 4;
SimileAjax.DateTime.HOUR			= 5;
SimileAjax.DateTime.DAY				= 6;
SimileAjax.DateTime.WEEK			= 7;
SimileAjax.DateTime.MONTH			= 8;
SimileAjax.DateTime.YEAR			= 9;
SimileAjax.DateTime.DECADE			= 10;
SimileAjax.DateTime.CENTURY			= 11;
...
SimileAjax.DateTime.gregorianUnitLengths = [];
    (function() {
        ...
        a[d.MILLISECOND] = 1;
        a[d.SECOND]      = 1000;
        a[d.QUATERMINUTE]= a[d.SECOND] * 15;
		a[d.MINUTE]		 = a[d.QUATERMINUTE] * 4;
		a[d.QUATERHOUR]	 = a[d.MINUTE] * 15;
		a[d.HOUR]		 = a[d.QUATERHOUR] * 4;
        a[d.DAY]         = a[d.HOUR] * 24;
        a[d.WEEK]        = a[d.DAY] * 7;
...
SimileAjax.DateTime.roundDownToInterval = function(date, intervalUnit, timeZone, multiple, firstDayOfWeek) {
    ...
    case SimileAjax.DateTime.SECOND:
        ...
        break;
	case SimileAjax.DateTime.QUATERMINUTE:
		date2.setUTCMilliseconds(0);
		date2.setUTCSeconds(Math.floor(date2.getUTCSeconds()/15)*15);
		break;
    case SimileAjax.DateTime.MINUTE:
        ...
        break;
	case SimileAjax.DateTime.QUATERHOUR:
		date2.setUTCMilliseconds(0);
		date2.setUTCSeconds(0);
		
		date2.getUTCMinutes(Math.floor(date2.getUTCMinutes()/15)*15);
		break;
 ...
 */
SimileAjax.DateTime.incrementByInterval = function(date, intervalUnit, timeZone, opts /* ZK Add*/) {
    ...
    switch(intervalUnit) {
    case SimileAjax.DateTime.MILLISECOND:
    	var inc = (opts && opts.incrementValue) ? opts.incrementValue : 50;
        date2.setTime(date2.getTime() + inc);
        break;
    case SimileAjax.DateTime.SECOND:
	...
	case SimileAjax.DateTime.QUATERHOUR:
		date2.setTime(date2.getTime()+
		SimileAjax.DateTime.gregorianUnitLengths[SimileAjax.DateTime.QUATERHOUR]);
		break;
    case SimileAjax.DateTime.HOUR:
        date2.setTime(date2.getTime() + 
            SimileAjax.DateTime.gregorianUnitLengths[SimileAjax.DateTime.HOUR]);
